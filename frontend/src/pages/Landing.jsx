  ...
  return (
    <div>
        ...
        <div className="app-container" style={{ position: 'relative', zIndex: 1 }}>
          <div style={{ maxWidth: 600 }}>
            ...
            <p style={{ fontSize: '1.1rem', color: 'var(--text-muted)', marginBottom: 36, lineHeight: 1.7 }}>
              No endless swiping. Milan is built for Nepalis who value genuine connection — send a heartfelt request, build a friendship first, and let love grow naturally.
            </p>
        ...
        <div className="app-container">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 28 }}>
            {[
              ...
              { icon: <MapPin size={28} />, title: 'Local Connections', desc: 'Find matches across Nepal — from Kathmandu to Pokhara and everywhere in between.' },
            ].map((f, i) => (
      ...
      <footer style={{ padding: '32px 0', borderTop: '1px solid var(--border)', textAlign: 'center', color: 'var(--text-muted)', fontSize: '0.85rem' }}>
        <div className="app-container">
          <p>मिलन Milan © 2024 — Made with ❤️ for Nepal</p>
        </div>
      </footer>
    </div>
  );
